...
const WeatherPage = () => {
  const { loading, weatherCards, handleAddWeatherCard, handleDeleteWeatherCard, setWeatherCards } = useWeather();
    ...
    <DndProvider backend={HTML5Backend}>
      <div className="min-h-screen bg-gradient-to-r from-blue-400 to-purple-500 p-4 flex items-center justify-center">
        <div className="max-w-2xl w-full bg-white p-6 rounded-lg shadow-lg">
          ...
          <WeatherForm onAddWeatherCard={handleAddWeatherCard} loading={loading} />
